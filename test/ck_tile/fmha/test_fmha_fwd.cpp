...
INSTANTIATE_TEST_SUITE_P(TestCkTileFmhaFwd,
                         ...
                         Combine(Values(std::tuple{1, 1},
                                 ...
                                 Values(std::tuple{2, 4, 2, 1, 1, "0"},
                                        std::tuple{2, 4, 2, 32, 32, "0"},
                                        std::tuple{2, 4, 2, 280, 512, "0"},
                                        std::tuple{3, 2, 2, 256, 128, "0"},
                                        std::tuple{2, 4, 2, 1, 1, "1"},
                                        std::tuple{2, 4, 2, 32, 32, "1"},
                                        std::tuple{2, 4, 2, 280, 512, "1"},
...
//                                  Values(0.1f),
//                                  Values(std::tuple{10, 123, false}),
//                                  Values(std::tuple{2, 4, 2, 1280, 1512, "1"},
//                                         std::tuple{3, 2, 2, 1256, 1128, "1"},
//                                         std::tuple{4, 3, 1, 1100, 1768, "2"},
//                                         std::tuple{2, 4, 2, 180, 112, "1"},
//                                         std::tuple{30, 18, 9, 156, 28, "1"},
//                                         std::tuple{4, 3, 1, 100, 68, "2"})));
