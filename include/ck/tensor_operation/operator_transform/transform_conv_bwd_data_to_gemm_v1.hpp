...
struct TransformConvBwdDataToGemm_v1
{
    ...
    __host__ __device__ TransformConvBwdDataToGemm_v1(
        ...
        : N_{static_cast<IndexType>(transform_conv_bwd_data_to_gemm_base.N_)},
          ...
          GStrideTensorA_{
              static_cast<IndexType>(transform_conv_bwd_data_to_gemm_base.GStrideTensorA_)},
          GStrideTensorB_{
            static_cast<IndexType>(transform_conv_bwd_data_to_gemm_base.GStrideTensorB_)},
          GStrideTensorC_{
              static_cast<IndexType>(transform_conv_bwd_data_to_gemm_base.GStrideTensorC_)},
    ...
    TransformConvBwdDataToGemm_v1(const ConvDimsType& a_g_n_k_wos_lengths,
        ...
        : Hi_{c_g_n_c_wis_lengths[HIdx]},
          ...
          GStrideTensorA_{a_g_n_k_wos_strides[I0]},
          GStrideTensorB_{b_g_k_c_xs_strides[I0]},
          GStrideTensorC_{c_g_n_c_wis_strides[I0]},
            ...
            else
            {
                ...
                else
                {
                    return make_naive_tensor_descriptor(
                        ...
                        make_tuple(NStrideTensorA_, HoStride_, WoStride_, GStrideTensorA_, KStrideTensorA_));
                }
            }
        }
    ...
    __host__ __device__ auto MakeWeiGridDesc() const
    {
        if constexpr(is_same_v<BLayout, tensor_layout::convolution::GKYXC>)
        {
            ...
            {
                return make_naive_tensor_descriptor_packed(make_tuple(K_, NumGroupsToMerge, Y_, X_, C_));
            }
        }
    ...
    __host__ __device__ auto MakeInGridDesc() const
    {
                          ...
                          is_same_v<CLayout, tensor_layout::convolution::NDHWGC>)
        {
            ...
            {
                return make_naive_tensor_descriptor(
                    make_tuple(N_, Di_, Hi_, Wi_, NumGroupsToMerge, C_, 1),
                    make_tuple(NStrideTensorC_,
                               DiStride_,
                               HiStride_,
                               WiStride_,
    ...
    __host__ __device__ auto MakeADescriptor_AK0_M_AK1() const
    {
                         ...
                         Filter1x1Stride1Pad0)
        {
            ...
            const auto out_gemmak0_gemmmraw_gemmak1_grid_desc = transform_tensor_descriptor(
                out_grid_desc,
                make_tuple(make_pass_through_transform(N_ * Do_ * Ho_ * Wo_ * NumGroupsToMerge),
        ...
        else
        {
            ...
            if constexpr(NDimSpatial == 2)
            {
                ...
                else
                {
                    ...
                    const auto out_gemmk_gemmmraw_grid_desc = transform_tensor_descriptor(
                        out_n_ydotslice_htildeslice_xdotslice_wtildeslice_k_grid_desc,
                        make_tuple(make_merge_transform(make_tuple(YDotSlice, XDotSlice, NumGroupsToMerge, K_)),
                                make_merge_transform(make_tuple(N_, HTildeSlice, WTildeSlice))),
                        make_tuple(Sequence<1, 3, 6, 5>{}, Sequence<0, 2, 4>{}),
                        make_tuple(Sequence<0>{}, Sequence<1>{}));
    ...
    __host__ __device__ auto MakeBDescriptor_BK0_N_BK1() const
    {
        ...
        else
        {
            ...
            if constexpr(NDimSpatial == 2)
            {
                if constexpr(NumGroupsToMerge == 1)
                {
                    const auto wei_k_ydot_ytilde_xdot_xtilde_c_grid_desc =
                        transform_tensor_descriptor(
                            wei_grid_desc,
                ...
                else
                {
                    ...
                    const auto wei_gemmk_gemmnraw_grid_desc = transform_tensor_descriptor(
                        wei_k_ydotslice_xdotslice_c_grid_desc,
                        make_tuple(make_merge_transform(make_tuple(YDotSlice, XDotSlice, K_, NumGroupsToMerge)),
                                make_pass_through_transform(C_)),
                ...
                if constexpr(NumGroupsToMerge == 1)
                {
                    ...
                    const auto in_gemmmraw_gemmnraw_grid_desc = transform_tensor_descriptor(
                        ...
                        make_tuple(make_freeze_transform(I0),
                                ...
                                make_merge_transform(make_tuple(N_, Hi_, Wi_)),
                                make_pass_through_transform(C_)),
                ...
                else
                {
                    ...
                    const auto in_n_y_ho_x_wo_mgxor_c_mgxor_grid_desc = transform_tensor_descriptor(
                        ...
                        make_tuple(
                            ...
                            make_embed_transform(make_tuple(I1, Wi_), make_tuple(I1, ConvStrideW_)),
                            make_pass_through_transform(C_)),
                        make_tuple(Sequence<0, 5>{}, Sequence<1>{}, Sequence<2>{}, Sequence<3>{}, Sequence<4>{}),
                        make_tuple(Sequence<0, 7>{}, Sequence<1>{}, Sequence<2, 3>{}, Sequence<4, 5>{}, Sequence<6>{}));
                    ...
                    const auto in_gemmmraw_gemmnraw_grid_desc = transform_tensor_descriptor(
                        ...
                        make_tuple(make_freeze_transform(I0),
                                make_freeze_transform(I0),
                                make_merge_transform(make_tuple(NumGroupsToMerge, N_, Hi_, Wi_)),
                ...
                else 
                {
                    ...
                    const auto in_n_ytilde_htilde_xtilde_wtilde_c_grid_desc =
                        transform_tensor_descriptor(
                            ...
                            make_tuple(
                                Sequence<0>{}, Sequence<1, 2>{}, Sequence<3, 4>{}, Sequence<5, 7>{}, Sequence<6>{}));
                    ...
                    const auto in_gemmmraw_gemmnraw_grid_desc = transform_tensor_descriptor(
                        in_n_htildeslice_wtildeslice_c_grid_desc,
                        make_tuple(make_merge_transform(make_tuple(N_, HTildeSlice, WTildeSlice, NumGroupsToMerge)),
                                   make_merge_transform(make_tuple(C_, NumGroupsToMerge))),
                        make_tuple(Sequence<0, 1, 2, 3>{}, Sequence<4, 5>{}),
                        make_tuple(Sequence<0>{}, Sequence<1>{}));
